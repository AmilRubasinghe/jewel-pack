 ...
 <section>
   <footer>
     <div class="footer">
                  ...
                  <div class="container">
                    <div class="row-copy-center">
                      <div class="travel-copyright">
                        <p> <center>Copy right &copy; 2019 web desing Srilanka</center></p>
                        <p> All rights design reserved design by <span>T E A M SPATA</span></p>
      ...
      border-color: rgba(221,221,221,.12);
          }  
